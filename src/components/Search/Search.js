...
const Search = () => { 
    ...
    return ( 
        <div className="relative max-w-lg mx-auto">
            ...
            {/* Search input */}
            <div className={`relative flex items-center h-16 rounded-lg focus-within:shadow-lg bg-white overflow-hidden transition-all duration-300 z-50 w-full`}> 
                <div className="grid place-items-center h-full w-16 text-gray-300"> 
                    <FaSearch size={24}/> 
                </div> 
                <input 
                    className="peer h-full w-full outline-none text-lg text-gray-700 pr-4" 
                    type="text" 
                    id="search" 
                    placeholder="Search" 
                    value={searchTerm} 
